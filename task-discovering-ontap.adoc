...
** link:concept-cloud-tiering.html[Learn about Cloud Tiering^]
...
* A valid set of NetApp Support Site credentials. See how to link:task-adding-nss-accounts.html[add NetApp Support Site accounts to Cloud Manager].
